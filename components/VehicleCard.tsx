...
const VehicleCard: React.FC<VehicleCardProps> = ({
    ...
    return (
        <Link href={`/vehicle/${id}`} className="group">
            <div className="flex flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer">
                {/* Image Section */}
